...
if [[ $# -eq 1 ]]; then
	...
	./algorithm_evaluation.py $SCENE_NUM 		save ./visualizations/scene_$SCENE_NUM/distribution_evaluation.pdf
	./algorithm_evaluation.py $SCENE_NUM means 	save ./visualizations/scene_$SCENE_NUM/mean_evaluation.pdf
else
