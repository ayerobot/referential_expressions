...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Distance between empirical and distribution means on training data}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1.1\textwidth]{images/mean_dist_test.png}
  \caption{Distance between empirical and distribution means on test data}
  \label{fig:sub2}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Negative log probability of data by command on training set}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1.1\textwidth]{images/logprob_test.png}
  \caption{Negative log probability of data by command on test set}
  \label{fig:sub2}
\end{subfigure}
\caption{Negative log probability of algorithms}
\label{fig:test}
\end{figure}
